...
namespace BigBirdConverge.Commons
{
    public static partial class R
    {
        public static class Files
        {
            ...
            public static string ProjectStatus = DirTool.Combine(Paths.App, "ProjectStatus.data");
            public static string SystemStatus = DirTool.Combine(Paths.App, "SystemStatus.data");
        }
    }
}
